...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests to test prompting of the HBNB commandline interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests to test for exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests to test my destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests to test my update from the HBNB command interpreter."""
